 ...
 * Last modified: 2021.04.11 at 12:00:38
...
class ExperienceDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('e_provider.name', function ($experience) {
                return getLinksColumnByRouteName([$experience->eProvider], 'eProviders.edit', 'id', 'name');
            })
